...
# **Mitigación del riesgo sísmico de la infraestructura escolar** {#mitigación-del-riesgo-sísmico-de-la-infraestructura-escolar}


**Rafael Fernández1\*, Luis Yamin1, Juan Carlos Reyes1, Angie Garcia1, Gustavo Fuentes1 & Juan Echeverry1**
...
\*Autor de contacto: Rafael Fernández. Centro de Investigación en Materiales y Obras Civiles, Departamento de Ingeniería Civil y Ambiental, Universidad de los Andes, Bogotá, Colombia. Correo-e: [ri.fernandez1110@uniandes.edu.co](mailto:ri.fernandez1110@uniandes.edu.co) 
...
3. ## **Alternativas de reforzamiento estructural**
...
* FEMA 308 \[27\].
  ...
  4. ## **Priorización y Planes de Mitigación del Riesgo Sísmico (PMRS)**
...
3. # **TIPOLOGÍAS PREDOMINANTES EN EL SECTOR**
...
2. ### **Pórticos de concreto reforzado con muros de mampostería**
...
3. ### **Pórticos de concreto reforzado con muros de mampostería generando columna corta**
...
| Programa de intervención |  | Número de edificaciones | Costo aproximado total de intervención  (COP$ millones) |
| :---: | :---: | :---: | :---: |
...
| Programa de intervención |  | Número de edificaciones | Costo aproximado de intervención  (COP$ millones) |
| :---: | :---: | :---: | :---: |
