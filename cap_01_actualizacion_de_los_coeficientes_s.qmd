...
# **Actualización de los coeficientes sísmicos de diseño estructural para la Norma Colombiana de Construcción Sismo Resistente NSR-22** {#actualización-de-los-coeficientes-sísmicos-de-diseño-estructural-para-la-norma-colombiana-de-construcción-sismo-resistente-nsr-22}

**Gabriel Bernal1,3\* & Omar Darío Cardona2,3**

1Departamento de Ingeniería Civil y Agrícola. Universidad Nacional de Colombia, Sede Bogotá, Colombia 

2Instituto de Estudios Ambientales. Universidad Nacional de Colombia, Sede Manizales, Colombia

3INGENIAR Investigación y Consultoría en Ingeniería para Análisis del Riesgo, Bogotá, Colombia

\*Autor de contacto: Gabriel Bernal. Departamento de Ingeniería Civil y Agrícola. Universidad Nacional de Colombia, Sede Bogotá, Colombia.  Correo-e: [gabernal@ingeniar-risk.com](mailto:gabernal@ingeniar-risk.com)
...
2. # **MOVIMIENTOS SÍSMICOS DE DISEÑO**
...
![Imagen que contiene mapaDescripción generada automáticamente][image9] ![][image10]
...
6. # **ESPECTROS PROPUESTOS Y COMPARACIÓN CON LA NSR-10**
...
| PColapso=0PColapso|SafSa∙dSa | (2) |
| :---: | :---- |
...
| ![][image24] | Primera iteración: Curva de fragilidad según ASCE 7 – 10/16 Sa \= 0.8 g (2,500 años) P(Colapso) \= 12%  |
| :---- | :---- |
| ![][image25] | Segunda iteración: Curva de fragilidad modificada Sa \= 1.3 g P(Colapso) \= 0.14%  |
| ![][image26] | Tercera iteración: Curva de fragilidad modificada Sa \= 1.1 g P(Colapso) \= 1.0%  |

**Figura 14.** Ilustración del proceso iterativo para construir la RTGM.

2. ## **Método de los coeficientes óptimos**
