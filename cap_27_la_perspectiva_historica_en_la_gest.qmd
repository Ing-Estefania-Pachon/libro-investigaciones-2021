---
title: "La perspectiva histórica en la gestión del riesgo de desastres: aplicación en Santiago de Cali, Colombia"
...
# **La perspectiva histórica en la gestión del riesgo de desastres: aplicación en Santiago de Cali, Colombia** {#la-perspectiva-histórica-en-la-gestión-del-riesgo-de-desastres:-aplicación-en-santiago-de-cali,-colombia}
...
2. # **LOS ESTUDIOS HISTÓRICOS EN LA GESTION DEL RIESGO** 
...
3. # **APLICACIONES EN LA CIUDAD SANTIAGO DE CALI** 
...
El área de estudio se enmarca en el municipio de Santiago de Cali, el cual se localiza al suroccidente colombiano, entre las coordenadas 3°27’26"N y 76°31’42"W. Geográficamente, se situa en la región s[ur del departamento del Valle del Cauca](https://es.wikipedia.org/wiki/Sur_del_Valle_del_Cauca), entre la cordillera Occidental y el valle del río Cauca a una altura promedio de 1,000 m.s.n.m. \[4\]. Presenta una superficie total de 561.7 km2, distribuida en 120.4 km2 del área urbana, 424.4 km2 del área rural, 16.3 km2 de la zona expansión urbana y 0.5 km2 área de protección del río Cauca \[5\] (Fig. 2).   
...
| Caja 1\. Método extensivista Existe otro método para el desarrollo de estudios históricos denominado extensivista. Se refiere a la búsqueda de fuentes de información que den cuenta de la ocurrencia de eventos que no aparecen registrados en bases de datos, ni catálogos oficialmente conocidos. Con este método extiende el conocimiento de eventos históricos ocurridos. |
| :---- |
...
1. ## **Sismos históricos en Santiago de Cali**
...
2. ###  **Reportes sobre eventos sísmicos** 
...
3. ### **Mapa de sismos históricos del municipio de Santiago de Cali en el periodo 1566–2018**
...
**![A close up of a mapDescription automatically generated][image172]**  
...
2. ##  **Movimientos en Masa históricos en Santiago de Cali**
...
1. ### **Conceptualización de movimientos en masa**
...
1. ### **Reportes sobre eventos por movimientos en masa** 
...
2. ### **Cartografía de movimientos en masa**
...
![A close up of a mapDescription automatically generated][image178]
...
3. ##  **Inundaciones históricas en Santiago de Cali**
...
1. ### **Conceptualización de inundación**
...
![A close up of a mapDescription automatically generated][image183]
...
![A close up of a mapDescription automatically generated][image184]
...
![A close up of a mapDescription automatically generated][image185]
...
2. # **GESTIÓN DEL RIESGO EN CALI Y SU RELACIÓN CON LA OCURRENCIA DE EVENTOS HISTÓRICOS** 
...
56. Aparicio, J. (2003). *Lluvias e inundaciones*. Recuperado el 24 de febrero del 2012 de la Web: [http://www.iaem.es/GuiasRiesgos/Lluviaseinundaciones.pdf](http://www.iaem.es/GuiasRiesgos/Lluviaseinundaciones.pdf)
